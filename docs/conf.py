...
# -*- coding: utf-8 -*-
#
# BorgCube documentation build configuration file, created by
# sphinx-quickstart.
#
...
release = get_distribution('borgcube').version
...
latex_documents = [
    (master_doc, 'BorgCube.tex', 'BorgCube Documentation',
     'Marian Beermann', 'manual'),
]
...
man_pages = [
    (master_doc, 'borgcube', 'BorgCube Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BorgCube', 'BorgCube Documentation',
     author, 'BorgCube', 'One line description of project.',
     'Miscellaneous'),
]
